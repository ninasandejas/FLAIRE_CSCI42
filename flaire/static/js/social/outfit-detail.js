document.addEventListener("DOMContentLoaded", function () {
  ...
  function showOutfitPostModal(data) {
      ...
      switchTabContent(defaultTab.dataset.tab, data);
  }
  ...
  function switchTabContent(tab, data = null) {
      if (tab === "comments") {
  ...
  if (commentForm) {
      commentForm.addEventListener("submit", e => {
          ...
          const outfitId = modal.dataset.outfitId;
          fetch(`/submit-comment/${outfitId}/`, {
              method: "POST",
              headers: {
              ...
              .then(newComment => {
                  const div = document.createElement("div");
                  div.classList.add("comment");
                  div.innerHTML = `<strong>@${newComment.author}</strong> ${newComment.entry}`;
